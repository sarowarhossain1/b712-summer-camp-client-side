import './Login.css';
import login from '../../assets/cover/login-cover.jpg'
  ...
  const handleValidateCaptcha = (e) =>{
   ...
   if(validateCaptcha(user_captcha_value)){
    ...
    return (
        <>
         <Helmet>
                <title>Unick | Login</title>
            </Helmet>
        <div className="hero min-h-screen bg-base-200 login-background gap-12">
  <div className="hero-content flex-col md:w-2/4 lg:flex-row">
